...
DECLARE
  ...
  v_model_version TEXT := format('v1.5_platform_calibrated_%sd', p_maturity_days);
...
BEGIN
  ...
  WITH platform_defaults AS (
    ...
    FROM (
      VALUES
        ('douyin', 0.40::NUMERIC, 0.66::NUMERIC, 0.52::NUMERIC, 1.05::NUMERIC),
        ('jd', 0.32::NUMERIC, 0.74::NUMERIC, 0.60::NUMERIC, 1.20::NUMERIC),
        ('taobao', 0.50::NUMERIC, 0.70::NUMERIC, 0.58::NUMERIC, 0.95::NUMERIC),
        ('wx', 0.35::NUMERIC, 0.74::NUMERIC, 0.60::NUMERIC, 1.20::NUMERIC),
        ('xhs', 0.46::NUMERIC, 0.82::NUMERIC, 0.74::NUMERIC, 1.10::NUMERIC)
