...
DECLARE
  ...
  v_model_version TEXT := format('v1.6_feedback_calibrated_%sd', p_maturity_days);
...
BEGIN
  ...
  WITH platform_defaults AS (
    ...
    FROM (
      VALUES
        ('douyin', 0.38::NUMERIC, 0.72::NUMERIC, 0.60::NUMERIC, 1.10::NUMERIC),
        ('jd', 0.30::NUMERIC, 0.82::NUMERIC, 0.72::NUMERIC, 1.30::NUMERIC),
        ('taobao', 0.48::NUMERIC, 0.74::NUMERIC, 0.62::NUMERIC, 1.00::NUMERIC),
        ('wx', 0.33::NUMERIC, 0.84::NUMERIC, 0.74::NUMERIC, 1.30::NUMERIC),
        ('xhs', 0.44::NUMERIC, 0.84::NUMERIC, 0.76::NUMERIC, 1.10::NUMERIC)
